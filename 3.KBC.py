...
for i  in range(0,15):
    ...
    for sublist in l2:
        print(f"{sublist}")
    a=input("Select one option of \"A\" ,\"B\",\"C\",\"D\":")
    if(a=="l3[i]"):
